...
__plugin_name__ = "netbox_softwares_plugin"

# Human-friendly plugin name, e.g. "NetBox Example Plugin"
__plugin_verbose_name__ = "NetBox Softwares Plugin"
...
__plugin_base_url__ = "netbox_softwares_plugin"
...
# URL to plugin documentation or source code repository
__plugin_url__ = "https://github.com/DevDorm/netbox-softwares"

# License identifier, e.g. "MIT", "Apache-2.0"
__plugin_license__ = "MIT"

# Certification status (not officially used by NetBox, but can be displayed locally)
__plugin_certified__ = True


from extras.plugins import PluginMenuItem, PluginMenu, PluginMenuGroup
