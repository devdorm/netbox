...
__plugin_name__ = "netbox_prefix_stats_plugin"

# Human-friendly plugin name, e.g. "NetBox Example Plugin"
__plugin_verbose_name__ = "NetBox Prefix Stats Plugin"

# Semantic version of the plugin, e.g. "1.0.0"
__plugin_version__ = "0.1.0"

# Short description of what the plugin does
__plugin_description__ = "NetBox plugin for prefix stats."
...
__plugin_base_url__ = "netbox_prefix_stats_plugin"
